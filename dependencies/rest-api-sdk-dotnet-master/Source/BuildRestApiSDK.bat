...
IF exist "C:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE\" ( call "C:\Program Files (x86)\Microsoft Visual Studio 11.0\Common7\IDE\devenv.exe" RestApiSDK.VS.2012.sln /build Release)