...
'=  reAuthorize.aspx
'=  Version 6.0 3/21/2006
'=
'=  Usage
'=		Sample page to execute a Re-Authorize Request
'======================================================================================%>
...
Session("refundAmount") = request("amount")
...
<form name="frm" method="POST" action="ccReAuthorize.aspx?execute=true">
<TABLE>
<TR bgcolor="ffff40">
...
<%
	...
	if (executeTransaction = "true") then
		...
		Dim strTermUrl, strCardEnrolled, strErrorNo, strErrorDesc, strStatusCode, strReasonCode
		Dim strAccountNumber, strTransactionId, strAuthCode
...
<b> Re-Authorization Transaction Request Results </b>
<TABLE>
<TR>
...
<br/><br/>
<b> Re-Authorization Transaction Results </b>
<TABLE>
<TR>
