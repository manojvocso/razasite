...
<%
	...
	' IIS Logging
	' Response.AppendToLog "BML Notification Received: " & notificationId
		...
		centinelRequest.Add ("MsgType", "cmpi_bml_status")
		...
		If strErrorNo = "" Then
			...
			' IIS Logging
			' Response.AppendToLog "cmpi_bml_status response: " & centinelResponse.GetUnparsedResponse()
