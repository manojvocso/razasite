...
{
    public class PayFlow_AuthCC_VeriSign
    {
        ...
        public void AuthCC(string requestId, string cardNumber, string expDate, string cvv2, double amount, string currencyCode,
            ...
            string Home_Phone, string IP_Address, string Cavv, string EciFlag, string Xid, string Comment1, string Comment2)
        {
            ...
            PayPal.Payments.DataObjects.CreditCard CC = new PayPal.Payments.DataObjects.CreditCard(cardNumber, expDate);
            CC.Cvv2 = cvv2;
    ...
    public class PayFlow_SaleCC_VeriSign
    {
        public string RESULT = "NULL";
        public string PNREF = "NULL";
        public string RESPMSG = "NULL";
    ...
    public class PayFlow_CaptureCC_VeriSign
    {
        public string RESULT = "NULL";
        public string PNREF = "NULL";
        public string RESPMSG = "NULL";
    ...
    public class PayFlow_VoidCC_VeriSign
    {
        public string RESULT = "NULL";
        public string PNREF = "NULL";
        public string RESPMSG = "NULL";
