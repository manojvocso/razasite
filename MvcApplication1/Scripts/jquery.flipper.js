     ...
     init : function( o ) {
       ...
       return this.each(function(){
         ...
         if ( ! data ) {
		   ...
		   new1 = $('<span class="fl-new fl-top fl-num"></span>');
           new2 = $('<span class="fl-new fl-bottom fl-num"></span>');
jQuery('#test2').html('');
jQuery('#test1').html('');
           cur1 = $('<span id="test2" class="fl-show fl-top fl-num" style="visibility:hidden;">'+text+'</span>');
           cur2 = $('<div class="fl-show fl-bottom fl-num" id="test1"></div>');
