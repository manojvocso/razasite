...
;(function($) {
    ...
    var LiteAccordion = function(elem, options) {
        ...
        var defaults = {
            containerWidth : 690,                   // fixed (px)
            containerHeight : 310,                  // fixed (px)
            headerWidth : 42,                       // fixed (px)
                ...
                setSlidePositions : function() {
                    ...
                    header.each(function(index) {
                        var $this = $(this),
                            ...
                            offset = parseInt(margin.css('marginLeft'), 5) || parseInt(margin.css('marginRight'), 5) || 0;
