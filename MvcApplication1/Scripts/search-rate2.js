...
$(document).ready(function () {
    ...
    ////******************** ADDED ON 11/12/14 TO DYNAMICALLY CHANGE META TAGS **************************
    //$.ajax({
    //    url: '/Rate/GetRatePage_MetaTag',
    //    data: {
    //        countryfrom: 1,
    //        countryto: 130
    //    },
    ...
    //        //alert(data.Title);
    //        //$("meta").attr("content", result.title);
    //        //$("title").val("Hello Raza Communication");
    ...
    //        alert(JSON.parse(jqXHR.responseText).ValidationMessage);
    //    }
    //});
    ...
    // binding server view model with server view model
    //if (serverViewModel != undefined && serverViewModel != null) {
    //    model.SetServerValues(serverViewModel);
    //}
