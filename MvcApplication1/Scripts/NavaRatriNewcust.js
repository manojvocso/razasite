...
function PromotionalPlan() {
    ...
    self.GetPromotionRate = function (countryfrom, countryto) {
        ...
        $.ajax({
            url: '/Promotion/GetNavaRatriNewCustomerPromotionRate',
            data: {
            ...
            success: function (resp) {
                ...
                //// alert(self.CountryFrom());
                //if (countryfrom == 1 && countryto == 224) {
                //    resp[3].RateperSign = "cent/min";
                //}
                //if (countryfrom == 2 && countryto == 224) {
                //    resp[3].RateperSign = "cent/min";
                //}
